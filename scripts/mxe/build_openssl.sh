...
./Configure --cross-compile-prefix=x86_64-w64-mingw32- mingw64 no-shared --with-zlib-include=${WORKDIR}/include --with-zlib-lib=${WORKDIR}/lib --prefix=${WORKDIR}/openssl --openssldir=${WORKDIR}/openssl OPENSSL_LIBS="-lcrypt32 -lws2_32"
make -j$THREADS
